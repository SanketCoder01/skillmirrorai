// =====================================================
// RECRUITER INBOX - WhatsApp Web-style messaging UI
    ...
    try {
      ...
      for (const msg of messagesData || []) {
        ...
        if (!conversationMap.has(partnerId)) {
          // Fetch partner details (student profile for recruiter inbox)
          const { data: partner } = await supabase
            .from('profiles')
            .select('full_name, university, avatar_url, skillmirror_id, course')
          ...
          conversationMap.set(partnerId, {
            ...
            participantName: partner?.full_name || 'Student',
            participantAvatar: partner?.avatar_url || null,
            participantSubtitle: partner?.university || null,
            participantSkillmirrorId: partner?.skillmirror_id || null,
